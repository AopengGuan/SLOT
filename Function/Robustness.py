...
def compute_robustness(comp_img, ref_local_stats, flows, options, params):
    ...
    if r_on:
        ...
        if bayer_mode:
            ...
            comp_local_stats = cuda.device_array(guide_imshape + (2, 3),
                                                 dtype=DEFAULT_NUMPY_FLOAT_TYPE)  # mu, sigma for rgb
        else:
    ...
    return r, R, S, d_sq, sigma_sq,d_p
